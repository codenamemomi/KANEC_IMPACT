    ...
    <section className="projects" id="projects">
      <div className="projects-container">
        <div className="projects-header">
          ...
          <p>
            We've selected verified deep networks of specialized community
            facilities driving real change.
          </p>
        </div>
        ...
        <div className="project-card">
          <div className="project-card-content">
            ...
            <p>
              Access our network of verified water initiatives to make your
              impact and drive your community forward. Whether you're looking to
              fund your next well or support existing facilities, our projects
              are easy to find – we support a wide range of areas.
            </p>
